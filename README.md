...
4. `복잡도(Complexity)`
    ...
    - 복잡도 표현 함수 : 0(영문자 대문자 오, 빅오)
    - 선형 검색 시간 복잡도 : $0(n)$
    - 이진 검색 시간 복잡도 : $0(log n)$
    - 시간복잡도 일반적 사용
        ...
        |$0(n^2)$| **이차 시간**| 이중 반복문, 이 이상은 실무에서 나오면 혹도가 아주 느려짐 |
        |$0(n^3)$| 삼차 시간| 삼중 반복문 |
